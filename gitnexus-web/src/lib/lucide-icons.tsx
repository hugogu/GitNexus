 ...
 */
/**
 * GitLab mark — local SVG icon for GitLab repository integration.
 *
 * Uses the GitLab fox logo (simplified outline version) to indicate GitLab
 * source-repo integration. Color defaults to `currentColor` for Tailwind
 * compatibility.
 */
export const Gitlab = forwardRef<SVGSVGElement, LucideProps>(function Gitlab(
  ...
  return (
    <svg
      ...
      {...rest}
    >
      <path d="M22.65 14.39L12 22.13 1.35 14.39a.84.84 0 0 1-.3-.94l1.22-3.78 2.44-7.51A.42.42 0 0 1 4.82 2a.43.43 0 0 1 .32 0 .42.42 0 0 1 .15.13l2.44 7.49h8.13l2.44-7.51a.42.42 0 0 1 .15-.13.43.43 0 0 1 .32 0 .42.42 0 0 1 .11.15l2.44 7.51 1.22 3.78a.84.84 0 0 1-.29.94z" />
    </svg>
  );
});
